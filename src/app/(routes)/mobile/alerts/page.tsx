...
export default function MobileAlerts() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useApiGet<JobAlertsResponse>(`job-alerts-for-jobseekers/get-job-alerts/${user?.id}`)
            ...
            >
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="title" className="text-right max-sm:text-left max-sm:col-span-4 sm:col-span-1">
                    Job Title
                  </Label>
                  <Input
                    id="title"
              ...
              <CardContent className="p-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-end">
                    <Switch checked={alert.isActive} onCheckedChange={() => toggleAlert(alert._id, !alert.isActive)} />
                    <Button
                      variant="ghost"
                      size="sm"
