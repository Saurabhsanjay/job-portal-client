    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-40 w-full bg-white border-b">
        <div className="flex h-14 items-center px-4">
          ...
          <div className="flex-1 mx-2 relative">
            ...
            <Input placeholder="Search jobs..." className="pl-8 h-9 md:w-[200px] lg:w-[300px]" />
          </div>
          ...
          <div className="py-4">
            <div className="space-y-1 px-3">
              {navigation.map((item) => (
                ...
                >
                  <item.icon
                    className={cn("mr-3 h-5 w-5", pathname === item.href ? "text-blue-600" : "text-gray-500")}
                  />
                  {item.name}
                </Link>
              ))}
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t flex justify-around items-center h-16">
        ...
        <Link
          ...
          className={cn(
            "flex flex-col items-center justify-center flex-1 h-full",
            pathname === "/mobile/applied-jobs" ? "text-blue-600" : "text-gray-500",
          )}
        >
