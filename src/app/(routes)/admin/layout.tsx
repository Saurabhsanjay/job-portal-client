...
// Updated navigation for admin panel
const navigation = [
...
const secondaryNavigation = [
  { name: "Change Password", href: "/admin/change-password", icon: Bell },
  { name: "Logout", href: "/admin/logout", icon: Bell },
]
      ...
      <nav className="sticky top-0 z-50 w-full border-b bg-white">
        <div className="flex h-16 items-center px-4 md:px-6">
          ...
          <div className="flex items-center gap-2 font-semibold">
            ...
            <span className="text-xl">Recruit-G Admin</span>
          </div>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    ...
                    <p className="text-xs leading-none text-muted-foreground">admin@recruit-g.com</p>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
