...
import { MessageSquare, UserCheck, Mail, Calendar, Clock, Users, ArrowLeftCircle } from "lucide-react"
...
const templates: Template[] = [
  ...
  },
  {
    ...
    variables: [
      { key: "{{candidate_name}}", label: "Candidate Name", example: "John Doe" },
      { key: "{{deadline_date}}", label: "Deadline Date", example: "January 15, 2024" },
  ...
  },
  {
    ...
    variables: [
      { key: "{{candidate_name}}", label: "Candidate Name", example: "John Doe" },
      { key: "{{assessment_link}}", label: "Assessment Link", example: "https://assessment.com/test" },
    ],
  ...
  },
  {
    ...
    variables: [
      { key: "{{candidate_name}}", label: "Candidate Name", example: "John Doe" },
      { key: "{{documents_list}}", label: "Documents List", example: "Passport, ID, Proof of Address" },
    ],
